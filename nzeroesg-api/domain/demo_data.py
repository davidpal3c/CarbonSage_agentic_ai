...
# These are fictional supplier service declarations, separate from shipment
# history. Historical rows may calibrate the screening rates, but do not decide
# whether a supplier is available on a lane.
DEMO_SUPPLIER_SERVICE_LANES = (
    SupplierServiceLane(
        ...
        "CAD",
        True,
        "fictional supplier service profile",
        "CS-1030",
    ),
    SupplierServiceLane(
        "Aurora Packaging",
