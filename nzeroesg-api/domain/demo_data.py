...
DEMO_SHIPMENTS_CSV = (
    b"shipment_id,shipment_date,origin,destination,weight_value,weight_unit,"
    b"distance_value,distance_unit,transport_method\n"
    b"CS-1001,2025-09-04,Edmonton,Calgary,12,mt,300,km,truck\n"
    b"CS-1002,2025-09-13,Vancouver,Toronto,8,mt,4400,km,train\n"
    b"CS-1003,2025-09-25,Shanghai,Vancouver,24,mt,10200,km,ocean container\n"
    b"CS-1004,2025-10-06,Toronto,Montreal,4.5,mt,540,km,truck\n"
    b"CS-1005,2025-10-17,Frankfurt,Toronto,1.2,mt,6350,km,plane\n"
    b"CS-1006,2025-10-28,Calgary,Seattle,6,mt,1100,km,train\n"
    b"CS-1007,2025-11-05,Monterrey,Dallas,10,mt,950,km,truck\n"
    b"CS-1008,2025-11-16,Busan,Vancouver,18,mt,8500,km,ship\n"
    b"CS-1009,2025-11-24,Winnipeg,Toronto,7.5,mt,2050,km,train\n"
    b"CS-1010,2025-12-03,Montreal,Halifax,5.5,mt,1250,km,truck\n"
    b"CS-1011,2025-12-15,Tokyo,Calgary,0.9,mt,8050,km,plane\n"
    b"CS-1012,2025-12-27,Rotterdam,Montreal,21,mt,5700,km,ship\n"
    b"CS-1013,2026-01-08,Regina,Edmonton,11,mt,780,km,train\n"
    b"CS-1014,2026-01-19,Chicago,Toronto,9,mt,835,km,truck\n"
    b"CS-1015,2026-01-29,Ho Chi Minh City,Vancouver,16,mt,11800,km,ship\n"
    b"CS-1016,2026-02-07,Calgary,Vancouver,6.5,mt,970,km,train\n"
    b"CS-1017,2026-02-18,Seattle,Edmonton,3.8,mt,1250,km,truck\n"
    b"CS-1018,2026-02-26,Seoul,Toronto,1.1,mt,10600,km,plane\n"
    b"CS-1019,2026-03-04,Quebec City,Montreal,5,mt,255,km,truck\n"
    b"CS-1020,2026-03-14,Vancouver,Winnipeg,13,mt,2300,km,train\n"
    b"CS-1021,2026-03-25,Barcelona,Halifax,19,mt,5200,km,ship\n"
    b"CS-1022,2026-04-06,Portland,Vancouver,7,mt,505,km,truck\n"
    b"CS-1023,2026-04-17,Montreal,Calgary,10,mt,3550,km,train\n"
    b"CS-1024,2026-04-28,Osaka,Toronto,0.8,mt,10400,km,plane\n"
    b"CS-1025,2026-05-05,Halifax,Montreal,22,mt,1250,km,ship\n"
    b"CS-1026,2026-05-16,Edmonton,Winnipeg,8.5,mt,1300,km,train\n"
    b"CS-1027,2026-05-27,Detroit,Toronto,6,mt,375,km,truck\n"
    b"CS-1028,2026-06-08,Calgary,Regina,4.8,mt,760,km,truck\n"
    b"CS-1029,2026-06-18,Hamburg,Halifax,25,mt,5300,km,ship\n"
    b"CS-1030,2026-06-29,Toronto,Vancouver,9,mt,4400,km,train\n"
    b"CS-1031,2026-07-07,Los Angeles,Vancouver,5.5,mt,2050,km,truck\n"
    b"CS-1032,2026-07-19,Taipei,Toronto,1,mt,12100,km,plane\n"
    b"CS-1033,2026-07-28,Prince Rupert,Montreal,15,mt,4750,km,train\n"
    b"CS-1034,2026-08-05,Vancouver,Calgary,7.2,mt,970,km,train\n"
    b"CS-1035,2026-08-12,Singapore,Vancouver,20,mt,12800,km,ship\n"
    b"CS-1036,2026-08-18,Ottawa,Toronto,4.2,mt,450,km,truck\n"
)
